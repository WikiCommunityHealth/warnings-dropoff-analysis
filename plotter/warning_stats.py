...
def plot_warnings_stats(file_path: str) -> None:
    ...
    try:
        user = df[
                ...
                df['count_warning_templates_transcluded'] == df['count_warning_templates_transcluded'].max()
            ].iloc[0]
    except:
    ...
    plot_line_chart(
        ...
        title = 'User analysis: normal warnings received compared to the activity',
    ...
    plot_line_chart(
        ...
        title = 'User analysis: normal warnings received',
    ...
    plot_line_chart_with_vertical_lines(
        x = user_data['date'],
        y = [
            (user_data['activities count'], 'serious')
        ],
